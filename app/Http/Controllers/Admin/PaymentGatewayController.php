...
class PaymentGatewayController extends Controller
{
    ...
    {
        $payments = PaymentGateway::latest()->paginate(10);
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(UpdatePaymentGatewayRequest $request, PaymentGateway $payment)
    {
    ...
    {
        $file2 = explode(asset('admin/images/payment') . '/', $file);
        if ($file) {
            $path = public_path() . '/admin/images/payment/' . $file2[1];
            if (File::exists($path)) {
                File::delete($path);
            }
        }
