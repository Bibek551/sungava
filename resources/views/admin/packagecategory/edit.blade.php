        ...
        <div class="card mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <small class="text-muted float-end">
                    <a href="{{ route('admin.packagecategories.index') }}" class="btn btn-primary"><i
                            class="fa-solid fa-arrow-left"></i>
                        Back</a>
                </small>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('admin.packagecategories.update', $packagecategory->id) }}"
                        ...
                        <div class="col-md-8">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror"
                                    value="{{ old('name', $packagecategory->name) }}" name="name" id=""
                                    placeholder="">
                                @error('name')
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" name="order"
                                            ...
                                            value="{{ old('order', $packagecategory->order) }}">
                                        @error('order')
                                            <div class="invalid-feedback" style="display: block;">
                                                {{ $message }}
                                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                @if ($packagecategory->image)
                                    <img src="{{ $packagecategory->image }}" width="100" class="mt-2 old-image">
                                @endif
                                @error('image')
                                    <div class="invalid-feedback" style="display: block;">
                                        {{ $message }}
