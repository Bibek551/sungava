...
@section('content')
    ...
    <div class="col-xl">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form class="row" method="POST" action="{{ route('admin.packages.store') }}"
                        ...
                        <div class="card card-body main-description shadow br-8 p-4">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-3">
                                    ...
                                    <input class="form-control @error('adult_price') is-invalid @enderror" type="text"
                                        name="adult_price" value="{{ old('adult_price') }}">
                                    @error('adult_price')
                                        <div class="invalid-feedback" style="display: block;">
                                            *{{ $message }}
                                        </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input class="form-control @error('fair_price') is-invalid @enderror" type="text"
                                        name="fair_price" value="{{ old('fair_price') }}">
                                    @error('fair_price')
                                        <div class="invalid-feedback" style="display: block;">
                                            *{{ $message }}
                                        </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea class="form-control @error('short_description') is-invalid @enderror" id="" name="short_description"
                                    rows="6" placeholder="">{{ old('short_description') }}</textarea>
                        ...
                        <div class="card-body card shadow br-8 my-3">
                            <div class="form-group mb-3">
                                ...
                                <input class="form-control @error('rating') is-invalid @enderror" type="number"
                                    min="1" max="5" name="rating" value="{{ old('rating') }}">
                            ...
                            <div class="tab-content" id="nav-tabContent">
                                        ...
                                        <div class="col-md-12">
                                            <table class="table table-border" id="dynamicAddRemoveService"
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="30%">
                                                        <input class="form-control mb-2" type="text"
                                                            name="addmoreservice[0][price]" placeholder="Enter Price" />
                                                    </td>
                                                    <td>
                                                        <button class="btn btn-link" id="add-btn-service" type="button"
                                                            name="addservice"><span
                                                                class="badge badge-center rounded-pill bg-primary"><i
                                                                    class="fa-solid fa-plus"></i></span></button>
                                                    </td>
                                                </tr>
                                ...
                                <div class="tab-pane fade" id="nav-inclusionexclusion" role="tabpanel"
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea class="form-control ixckeditor" id="" name="inclusion" cols="30" rows="10">{{ old('inclusion') }}</textarea>
                                        @error('inclusion')
                                            <div class="invalid-feedback" style="display: block;">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea class="form-control exckeditor" id="" name="exclusion" cols="30" rows="10">{{ old('exclusion') }}</textarea>
                                        @error('exclusion')
                                            <div class="invalid-feedback" style="display: block;">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control @error('activities') is-invalid @enderror"
                                                type="text" name="activities" value="{{ old('activities') }}">
                                            @error('activities')
                                                <div class="invalid-feedback" style="display: block;">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control @error('trip_grade') is-invalid @enderror"
                                                type="text" name="trip_grade" value="{{ old('trip_grade') }}">
                                            @error('trip_grade')
                                                <div class="invalid-feedback" style="display: block;">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control @error('trip_type') is-invalid @enderror"
                                                type="text" name="trip_type" value="{{ old('trip_type') }}">
                                            @error('trip_type')
                                                <div class="invalid-feedback" style="display: block;">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control @error('trip_mode') is-invalid @enderror"
                                                type="text" name="trip_mode" value="{{ old('trip_mode') }}">
                                            @error('trip_mode')
                                                <div class="invalid-feedback" style="display: block;">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control @error('trip_duration') is-invalid @enderror"
                                                type="text" name="trip_duration" value="{{ old('trip_duration') }}">
                                            @error('trip_duration')
                                                <div class="invalid-feedback" style="display: block;">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control @error('accomodation') is-invalid @enderror"
                                                type="text" name="accomodation" value="{{ old('accomodation') }}">
                                            @error('accomodation')
                                                <div class="invalid-feedback" style="display: block;">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control @error('best_season') is-invalid @enderror"
                                                type="text" name="best_season" value="{{ old('best_season') }}">
                                            @error('best_season')
                                                <div class="invalid-feedback" style="display: block;">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control @error('group_size') is-invalid @enderror"
                                                type="text" name="group_size" value="{{ old('group_size') }}">
                                            @error('group_size')
                                                <div class="invalid-feedback" style="display: block;">
                                                    {{ $message }}
                                                </div>
    ...
    <script>
        ...
        $("#add-btn").click(function() {
            ...
            $("#dynamicAddRemove").append('<tr><td style="width: 95%"><input type="text" name="addmore[' + i +
                ...
                i +
                '][description]"  class="form-control itineraryeditor' +
                i +
        ...
        $("#add-btn-service").click(function() {
            ...
            $("#dynamicAddRemoveService").append(
                ...
                '][service]" placeholder="Enter Service" class="form-control mb-2" /></td><td style="width: 30%"><input type="text" name="addmoreservice[' +
                j +
