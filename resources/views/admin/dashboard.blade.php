                        ...
                        <div class="card-body">
                            <div class="card-title d-flex align-items-start justify-content-between">
                                <div class="avatar flex-shrink-0">
                                    <i class="menu-icon tf-icons bx bx-package icon-style"></i>
                                </div>
                            </div>
                            <span class="fw-semibold d-block mb-1">Packages</span>
                            <h3 class="card-title mb-2">{{ $packages ?? 0 }}</h3>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-12 col-6 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <div class="card-title d-flex align-items-start justify-content-between">
                                <div class="avatar flex-shrink-0">
                                    <i class="menu-icon tf-icons bx bx-world icon-style"></i>
                                </div>

                            </div>
                            <span class="fw-semibold d-block mb-1">Destinations</span>
                            <h3 class="card-title mb-2">{{ $destinations ?? 0 }}</h3>
                ...
                <div class="col-lg-3 col-md-12 col-6 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <div class="card-title d-flex align-items-start justify-content-between">
                                <div class="avatar flex-shrink-0">
                                    <i class="menu-icon tf-icons bx bx-support icon-style icon-style"></i>
                                </div>
